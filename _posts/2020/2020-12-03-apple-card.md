...
<figure>
{% image "./assets/apple-card-overview.jpg", "Apple Card is an entire expierence available from the Wallet app." %}
...
<figure>
{% image "./assets/apple-card-monthly-spending.jpg", "Apple Card clearly shows you what you've spent each month broken down by categories." %}
...
<figure>
{% image "./assets/apple-card-transactions.jpg", "Apple Card allows you to see all of the transactions for a particular merchant." %}
...
<figure>
{% image "./assets/apple-card-payment.jpg", "Apple Card payments are easy and clear with a clever circular control for derterming how much to pay." %}
